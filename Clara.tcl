...
# A partir d'ici vous ne devez plus toucher au ligne de code ! Risque de bug
...
if { [lindex $arg 0] == "PING" } { putdcc $Clara(idx) "PONG [lindex $arg 1]"; set Clara(counter) "0" }
if { [lindex $arg 0] == "NICK"  } { set nick [string trim [lindex $arg 1] :]
set ident [string trim [lindex $arg 4] :]
set host [string trim [lindex $arg 5] :]
set real [string trim [lrange $arg 8 end] :]
return 0
}
if { [lindex $arg 1] == "JOIN" } { set nick [string trim [lindex $arg 0] :]
set chan [string trim [lindex $arg 2] :]
return 0
}
if {[lindex $arg 1]=="PART"} { set nick [string trim [lindex $arg 0] :]
set chan [string trim [lindex $arg 2] :]
return 0
}
